...
>>>>>>> ada457b948428f6ad28826d6c946fa289d94eed2
#| echo: false
...
nogenlunde lige godt på vores data. Men i @fig-2grad_3grad_zoom har vi zoomet ud på plottet
...
nye datapunkter i lyserød. Nu beskriver syvendegradspolynomiet pludselig
ikke datapunkterne så godt længere.

```{r overfitting, fig.width=8, fig.height=4}
#| echo: false
#| fig-cap: Et andengradspolynomium (rød) og et syvendegradspolynomium (blå) fittet til 20 nye datapunkter (lyserød). 
...
x2<-1:400/100 -1
<<<<<<< HEAD
plot(x,x1+v,col="magenta", main="Grad 2", ,ylab="y")
lines(x2,predict(model,data.frame(x=x2)),col="red")
#plot(x,y)
plot(x,x1+v,col="magenta",main="Grad 7", ,ylab="y")
=======
plot(x,x1+v,col="magenta", main="Grad 2",ylab="y")
lines(x2,predict(model,data.frame(x=x2)),col="red")
#plot(x,y)
...
når vi bruger de lyserøde datapunkter som testdata. Andengradspolynomiet
